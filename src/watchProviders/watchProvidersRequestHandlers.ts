...
import { watchProviderQuerySchema, watchProvidersResponseSchema } from "./schemas/watchProvidersSchemas";
import { watchProvidersAvailableQuerySchema, watchProvidersAvailableResponseSchema } from "./schemas/watchProvidersAvailableSchemas";

export const watchProvidersRequestHandlers = createRequestNamespace((apiKey) => ({
  ...
  getTVWatchProviders: createRequestHandler(
    apiKey,
    'watch/providers/tv',
    {
      querySchema: watchProviderQuerySchema,
